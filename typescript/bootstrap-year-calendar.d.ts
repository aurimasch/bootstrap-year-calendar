...
interface Calendar<T extends CalendarDataSourceElement> {
     ...
     */
    setAlwaysHalfDay(alwaysHalfDay: boolean, preventRedering: boolean
     ...
     * @param preventRedering Indicates whether the rendering should be prevented after the property update.
     */
    setContextMenuItems(contextMenuItems: CalendarContextMenuItem<T>[], preventRedering: boolean
     ...
     * @param preventRedering Indicates whether the rendering should be prevented after the property update.
     */
    setCustomDayRenderer(handler: (element: JQuery, currentDate: Date) => void, preventRedering: boolean
     ...
     * @param preventRedering Indicates whether the rendering should be prevented after the property update.
     */
    setCustomDataSourceRenderer(handler: (element: JQuery, currentDate: Date, events: T[]) => void, preventRedering: boolean
     ...
     * @param preventRedering Indicates whether the rendering should be prevented after the property update.
     */
    setDataSource(dataSource: T[], preventRedering: boolean
     ...
     * @param preventRedering Indicates whether the rendering should be prevented after the property update.
     */
    setDisableDays(disableDays: Date[], preventRedering: boolean
     ...
     * @param preventRedering Indicates whether the rendering should be prevented after the property update.
     */
    setDisabledWeekDays(disabledWeekDays: int[], preventRedering: boolean
     ...
     * @param preventRedering Indicates whether the rendering should be prevented after the property update.
     */
    setHiddenWeekDays(hiddenWeekDays: int[], preventRedering: boolean
     ...
     * @param preventRedering Indicates whether the rendering should be prevented after the property update.
     */
    setDisplayDisabledDataSource(displayDisabledDataSource: boolean, preventRedering: boolean
     ...
     * @param preventRedering Indicates whether the rendering should be prevented after the property update.
     */
    setDisplayWeekNumber(displayWeekNumber: boolean, preventRedering: boolean
     ...
     * @param preventRedering Indicates whether the rendering should be prevented after the property update.
     */
    setDisplayHeader(displayHeader: boolean, preventRedering: boolean
     ...
     * @param preventRedering Indicates whether the rendering should be prevented after the property update.
     */
    setEnableContextMenu(enableContextMenu: boolean, preventRedering: boolean
     ...
     * @param preventRedering Indicates whether the rendering should be prevented after the property update.
     */
    setEnableRangeSelection(enableRangeSelection: boolean, preventRedering: boolean
     ...
     * @param preventRedering Indicates whether the rendering should be prevented after the property update.
     */
    setLanguage(language: string, preventRedering: boolean
     ...
     * @param preventRedering Indicates whether the rendering should be prevented after the property update.
     */
    setMaxDate(maxDate: Date, preventRedering: boolean
     ...
     * @param preventRedering Indicates whether the rendering should be prevented after the property update.
     */
    setMinDate(minDate: Date, preventRedering: boolean
     ...
     * @param preventRedering Indicates whether the rendering should be prevented after the property update.
     */
    setRoundRangeLimits(roundRangeLimits: boolean, preventRedering: boolean
     ...
     * @param preventRedering Indicates whether the rendering should be prevented after the property update.
     */
    setStyle(style: string, preventRedering: boolean
     ...
     * @param preventRedering Indicates whether the rendering should be prevented after the property update.
     */
    setWeekStart(weekStart: number, preventRedering: boolean
